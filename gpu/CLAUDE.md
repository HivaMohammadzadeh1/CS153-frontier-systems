Drop this file at the root of your project repo so Claude Code (or any AI coding assistant) understands the cluster environment you're working on. Edit the `Hiva` line before checking in.
...
- **My username on the cluster**: `Hiva` ← edit this
- **My home directory**: `/home/Hiva` (on a shared Weka filesystem mounted on the login pod and all workers).
...
- **My login pod selector**: `kubectl get pod -n slurm -l stanford/user=Hiva`
- **Pod name pattern**: `slurm-login-hiva-58b746b74b-k6w82 `
